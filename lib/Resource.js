...
Resource.prototype = {
  ...
  _responseHandler: function (req, callback) {
    ...
    return function (res) {
      ...
      res.on('end', function () {
        ...
        self._logger.debug({ message: `Shippo HTTP Response: ${response}, statusCode: ${res.statusCode}`, reqId: self._shippo.reqId });
        try {
  ...
  _request: function (method, path, data, auth, callback) {
    ...
    self._logger.debug({ message: `Shippo HTTP Request: ${method} data: ${JSON.stringify(data)} path: ${path}`, reqId: self._shippo.reqId });
