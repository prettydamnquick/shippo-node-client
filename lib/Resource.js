...
Resource.prototype = {
  ...
  _responseHandler: function (req, callback) {
    ...
    return function (res) {
      ...
      res.on('end', function () {
        ...
        self._logger.info(`Shippo logger Response: ${response}, statusCode: ${res.statusCode}`);
        try {
  ...
  _request: function (method, path, data, auth, callback) {
    ...
    this._logger.info(`Shippo logger Request: ${method} data: ${JSON.stringify(data)} path: ${path}`);
