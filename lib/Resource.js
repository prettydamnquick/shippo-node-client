...
Resource.prototype = {
  ...
  _responseHandler: function (req, callback) {
    ...
    return function (res) {
      ...
      res.on('end', function () {
        ...
        this._logger.info(`Shippo logger Response: ${response}, statusCode: ${res.statusCode}`);
        try {
  ...
  _request: function (method, path, data, auth, callback) {
    ...
    this._logger.info(`Shippo logger Request: ${method} queryParams: ${queryParams} path: ${path}`);
